    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><?=_("Edit Product")?></h1>
                                    ...
                                    <form method="POST" action="/Product/update/<?= $product->prod_id ?>" class="tm-edit-product-form" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="product_category" class="form-select" id="category" required>
                                                <option><?=_("Select category")?></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group form-check mb-3 col-xs-12 col-sm-6">
                                                ...
                                                <label class="text-muted" for="start_date"><?=_("Start: ")?><input value="<?= $ads->start_date ?>" id="startDate" name="startDate" type="date" class="form-control"> </label>
                                                <label lass="text-muted" for="end_date"><?=_("Ends: ")?><input value="<?= $ads->end_date ?>" id="endDate" name="endDate" type="date" class="form-control "></label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="update" data-bs-dismiss="modal" class="btn btn-primary"><?=_("Save changes")?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
